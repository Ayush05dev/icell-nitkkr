          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-[#555] text-sm mt-1">
                Create teams and assign member positions
              </p>
            </div>
            <button
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span
                        ...
                        style={{
                          background: `${currentTeam.color}18`,
                  ...
                  <div className="divide-y" style={{ borderColor: "#1f1f1f" }}>
                    {currentTeam.members.map((member) => (
                      <div
                        key={member.id}
                        className="px-6 py-4 flex items-center gap-4 hover:bg-[#161616] transition-colors"
                      >
                        <div
                        ...
                        {editMember === member.id ? (
                          <select
                            ...
                            onChange={(e) =>
                              updateMemberPosition(member.id, e.target.value)
                            }
                    ...
                    <div className="flex gap-2">
                      {[
                        ...
                        <button
                          key={c}
                          onClick={() =>
                            setTeamForm((f) => ({ ...f, color: c }))
                          }
                          className="w-8 h-8 rounded-full transition-transform hover:scale-110"
                          style={{
                            background: c,
                            outline:
                              teamForm.color === c ? `2px solid ${c}` : "none",
                            outlineOffset: "2px",
                          }}
                        />
                      ))}
